...
let t7 (x: {| a: int; b: NestedRecTy |}) = {| x with c.D = "a" |}
    ...
    |> withDiagnostics [
        ...
        (Error 1129, Line 12, Col 55, Line 12, Col 56, "The record type 'NestedRecTy' does not contain a label 'C'.")
        (Error 1129, Line 13, Col 57, Line 13, Col 58, "The record type '{| a: int |}' does not contain a label 'b'.")
        (Error 1129, Line 14, Col 53, Line 14, Col 54, "The record type '{| a: int; b: NestedRecTy |}' does not contain a label 'c'.")
    ]